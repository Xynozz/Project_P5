            ...
            <div class="card-body pt-3 p-3">
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                        <div class="d-flex flex-column">
                            <h5 class="mb-3">
                                <a style="text-decoration:none" href="{{route('destinasi.show', $item->id)}}">Detail Wisata</a>
                            </h5>
                            <span class="mb-2">Nama Wisata: <span
                                    class="text-dark font-weight-bold ms-sm-2">{{$item->nama_tempat}}</span></span>
                            <span class="mb-2">Harga Tiket: <span
                                    class="text-dark ms-sm-2 font-weight-bold">{{$item->harga}}</span></span>
                            <span class="mb-2">Deskripsi : <span
                                    class="text-dark ms-sm-2 font-weight-bold">{{$item->deskripsi}}</span></span>
                            <span class="mb-2">Image :
                                <img src="{{asset('images/destinasi/'.$item->foto)}}" alt="" style="width: 400px"></span>
                            <span class="mb-2">Deskripsi : <span
                                    class="text-dark ms-sm-2 font-weight-bold">{{$item->deskripsi}}</span></span>
                        </div>
                        <div class="ms-auto text-end">
                            ...
                            <a style="text-decoration:none" class="btn btn-link text-dark px-3 mb-0"
                            href="{{route('destinasi.edit', $item->id)}}"><i class="material-icons text-sm me-2">edit</i>Edit</a>
                            </form>
                        </div>
                    </li>
                    @endforeach
